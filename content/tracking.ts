import { fetchInfo } from './utils/httpUtils'
const track_elem_selector = ':scope div[data-component="shipmentConnections"] a'
...
export async function fetchTrackInfo(delivBox) {
	...
	for (let rb of rightButtons) {
		console.log(rb.textContent)
		if (rb.textContent.includes('Track package') || rb.textContent.includes('Lieferung verfolgen')) {
