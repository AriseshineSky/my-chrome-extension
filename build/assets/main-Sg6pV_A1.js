...
const App = () => {
  ...
  const [isButtonActive, setIsButtonActive] = reactExports.useState(true);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "App", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "fetchOrders", onClick: handleFetchOrders, disabled: !isButtonActive, children: "Fetch Orders" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { id: "output", children: orders ? JSON.stringify(orders, null, 2) : "No orders fetched yet." })
  ] });
};
